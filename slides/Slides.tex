...
\definecolor{DarkBlue}{RGB}{43,43,122}%Define a Color
\definecolor{MyGrey}{RGB}{43,43,122}
\hypersetup{
            colorlinks,
            breaklinks,
			      urlcolor=DarkBlue,
...
\newpage
We tested the probability distribution function (PDF) of \nhyd in our cores, and good ($p>0.05$ in K-S test) log-normal distribution were found, without exhibiting "power-law tail". Such log-normal PDFs indicate that turbulence is dominating the density structure of gas in our cores. We compare our results with the gravity affected PDF by \citet{2013ApJ...766L..17S}.
\begin{figure}[H]
          \centering
          \includegraphics[totalheight=53 mm]{PDF/{PDF_G173.60-17.89C2_final}.eps}
          \includegraphics[totalheight=53 mm]{PDF/PDF_Gravity.eps}
\end{figure}
...
\begin{figure}[H]
          \centering
          \includegraphics[totalheight=53 mm]{PDF/{PDF_G159.21-20.12C1_final}.eps}
          \includegraphics[totalheight=53 mm]{PDF/PDF_Gravity.eps}
\end{figure}
...
\begin{figure}[H]
          \centering
          \includegraphics[totalheight=53 mm]{PDF/{PDF_G157.60-12.17bC2_final}.eps}
          \includegraphics[totalheight=53 mm]{PDF/PDF_Gravity.eps}
\end{figure}
\newpage
